...
public class CrossbodyBag extends Bag{
    ...
    public CrossbodyBag(String colourInput, int capactiyInput, int numberOfStrapsInput){
        super(colourInput, capactiyInput);
        this.numberOfStraps = numberOfStrapsInput;
